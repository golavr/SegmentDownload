...
namespace SegmentDownloader.IEPlugin
{
	...
	[BandObject("SegmentDownloader", BandObjectStyle.Horizontal | BandObjectStyle.ExplorerToolbar | BandObjectStyle.TaskbarToolBar)]
	public class IEMD : BandObject
	{
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTips.SetToolTip(this.btnDownload, "Download video using SegmentDownloader");
            ...
            this.toolTips.SetToolTip(this.btnOpenDownloader, "Lauch SegmentDownloader");
        ...
        private void DownloadURL(string url)
        {
            try
            {
                ...
                if (url != null)
                {
                    p = Process.Start(Settings.SegmentDownloaderPath, String.Format("/sw {0}", url));
                }
                else
                {
                    p = Process.Start(Settings.SegmentDownloaderPath);
                }
